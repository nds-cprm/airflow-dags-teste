select 
    ...
    gu.shape,
    decode(p_escala, 4, '250000', 5, '100000', 17, '150000', 6, '50000', 7, '25000') grupo,
...
where gu.id_mapa in (
    select cod_mapa from geobank.wm_mapas where cod_escala = p_escala and cod_grupo <> 3 and cod_mapa not in (188, 189, 270)
)
